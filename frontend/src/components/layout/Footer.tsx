          ...
          <div>
            ...
            <div
              ...
              style={{
                ...
                borderRadius: 16,
                boxShadow: '0 8px 24px rgba(31, 58, 36, 0.08)',
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.75rem',
            ...
            >
              ...
              <div>
                <div style={{ fontSize: '0.64rem', textTransform: 'uppercase', letterSpacing: '0.08em', color: '#4A6B52', fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4 }}>
                  <Code2 size={11} color="#2E6B3E" /> Lead Architect & Developer
                </div>
                <a
